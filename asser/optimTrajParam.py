...
def trajFunction(d_cfgTraj):
    ...
    #~ deplacement = commandMsg("MSG_MAIN_GOTO 0 1 -1.57") # Commande de rotation
    #
    deplacement = commandMsg("MSG_MAIN_GOTO 2 1 -1100000") # Commande de déplacement ligne droite
    deplacement.addPose("0.0 1.0")
    
    # config de deplacement multipoint de quart de tour à droite en 4 segments
