...
ELEVATOR_UP   = (ACTUATOR_TYPE_SERVO_RX, 0, 123, DEFAULT_RX_SERVOS_TIMEOUT_MS)
ELEVATOR_DOWN = (ACTUATOR_TYPE_SERVO_RX, 0, 64,  DEFAULT_RX_SERVOS_TIMEOUT_MS)
ARM_1_OPEN    = (ACTUATOR_TYPE_SERVO_RX, 1, 123, DEFAULT_RX_SERVOS_TIMEOUT_MS)
ARM_1_CLOSE   = (ACTUATOR_TYPE_SERVO_RX, 1, 64,  DEFAULT_RX_SERVOS_TIMEOUT_MS)
ARM_2_OPEN    = (ACTUATOR_TYPE_SERVO_RX, 2, 123, DEFAULT_RX_SERVOS_TIMEOUT_MS)
ARM_2_CLOSE   = (ACTUATOR_TYPE_SERVO_RX, 2, 64,  DEFAULT_RX_SERVOS_TIMEOUT_MS)

# AX Servos
DEFAULT_AX_SERVOS_TIMEOUT_MS = DEFAULT_SERVOS_TIMEOUT_MS
FIRE_FLIPPER_OPEN      = (ACTUATOR_TYPE_SERVO_AX, 2, 55,  DEFAULT_AX_SERVOS_TIMEOUT_MS) # ID: OK - ANGLE : OK
FIRE_FLIPPER_CLOSE     = (ACTUATOR_TYPE_SERVO_AX, 2, 180, DEFAULT_AX_SERVOS_TIMEOUT_MS) # ID: OK - ANGLE : OK
TORCH_GUIDE_OPEN       = (ACTUATOR_TYPE_SERVO_AX, 1, 123, DEFAULT_AX_SERVOS_TIMEOUT_MS)
TORCH_GUIDE_CLOSE      = (ACTUATOR_TYPE_SERVO_AX, 1, 64,  DEFAULT_AX_SERVOS_TIMEOUT_MS)
FRUITMOTH_HATCH_OPEN   = (ACTUATOR_TYPE_SERVO_AX, 2, 123, DEFAULT_AX_SERVOS_TIMEOUT_MS)
FRUITMOTH_HATCH_CLOSE  = (ACTUATOR_TYPE_SERVO_AX, 2, 64,  DEFAULT_AX_SERVOS_TIMEOUT_MS)
FRUITMOTH_TUB_OPEN     = (ACTUATOR_TYPE_SERVO_AX, 3, 123, DEFAULT_AX_SERVOS_TIMEOUT_MS)
FRUITMOTH_TUB_CLOSE    = (ACTUATOR_TYPE_SERVO_AX, 3, 64,  DEFAULT_AX_SERVOS_TIMEOUT_MS)
FRUITMOTH_ARM_OPEN     = (ACTUATOR_TYPE_SERVO_AX, 4, 123, DEFAULT_AX_SERVOS_TIMEOUT_MS)
FRUITMOTH_ARM_CLOSE    = (ACTUATOR_TYPE_SERVO_AX, 4, 64,  DEFAULT_AX_SERVOS_TIMEOUT_MS)
FRUITMOTH_FINGER_OPEN  = (ACTUATOR_TYPE_SERVO_AX, 5, 123, DEFAULT_AX_SERVOS_TIMEOUT_MS)
FRUITMOTH_FINGER_CLOSE = (ACTUATOR_TYPE_SERVO_AX, 5, 64,  DEFAULT_AX_SERVOS_TIMEOUT_MS)

# Relays
MAIN_GUN_FIRE      = (ACTUATOR_TYPE_RELAY, 1, ACTION_ON)  # ID: OK - ACTION: OK
MAIN_GUN_LOAD      = (ACTUATOR_TYPE_RELAY, 1, ACTION_OFF) # ID: OK - ACTION: OK
SECONDARY_GUN_FIRE = (ACTUATOR_TYPE_RELAY, 1, ACTION_ON)  # ID: OK - ACTION: OK
SECONDARY_GUN_LOAD = (ACTUATOR_TYPE_RELAY, 1, ACTION_OFF) # ID: OK - ACTION: OK
MAMMOTH_NET_THROW  = (ACTUATOR_TYPE_RELAY, 2, ACTION_ON)  # ID: OK - ACTION: OK
MAMMOTH_NET_LOAD   = (ACTUATOR_TYPE_RELAY, 2, ACTION_OFF) # ID: OK - ACTION: OK
VALVE_ON           = (ACTUATOR_TYPE_RELAY, 3, ACTION_ON)  # ID: OK
VALVE_OFF          = (ACTUATOR_TYPE_RELAY, 3, ACTION_OFF) # ID: OK
PAINT_1_RELEASE    = (ACTUATOR_TYPE_RELAY, 2, ACTION_ON)  # ID: OK - ACTION: OK
PAINT_1_HOLD       = (ACTUATOR_TYPE_RELAY, 2, ACTION_OFF) # ID: OK - ACTION: OK
PAINT_2_RELEASE    = (ACTUATOR_TYPE_RELAY, 3, ACTION_ON)  # ID: OK - ACTION: OK
PAINT_2_HOLD       = (ACTUATOR_TYPE_RELAY, 3, ACTION_OFF) # ID: OK - ACTION: OK
