...
SECONDARY_FIRE_FLIPPER_OPEN  = (SERVO_TYPE_AX, 2, 123, DEFAULT_AX_SERVOS_TIMEOUT_MS) # ID: OK
SECONDARY_FIRE_FLIPPER_CLOSE = (SERVO_TYPE_AX, 2, 64,  DEFAULT_AX_SERVOS_TIMEOUT_MS) # ID: OK
