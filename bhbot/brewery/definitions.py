...
FRUITMOTH_ARM_OPEN           = (SERVO_TYPE_AX, 4, 123, DEFAULT_AX_SERVOS_TIMEOUT_MS)
FRUITMOTH_ARM_CLOSE          = (SERVO_TYPE_AX, 4, 64,  DEFAULT_AX_SERVOS_TIMEOUT_MS)
FRUITMOTH_FINGER_OPEN        = (SERVO_TYPE_AX, 5, 123, DEFAULT_AX_SERVOS_TIMEOUT_MS)
FRUITMOTH_FINGER_CLOSE       = (SERVO_TYPE_AX, 5, 64,  DEFAULT_AX_SERVOS_TIMEOUT_MS)

# Relays
MAIN_GUN_FIRE      = (1, ACTION_ON)  # ID: OK - ACTION: OK
MAIN_GUN_LOAD      = (1, ACTION_OFF) # ID: OK - ACTION: OK
SECONDARY_GUN_FIRE = (1, ACTION_ON)  # ID: OK - ACTION: OK
SECONDARY_GUN_LOAD = (1, ACTION_OFF) # ID: OK - ACTION: OK
MAMMOTH_NET_THROW  = (2, ACTION_ON)  # ID: OK - ACTION: OK
MAMMOTH_NET_LOAD   = (2, ACTION_OFF) # ID: OK - ACTION: OK
VALVE_ON           = (3, ACTION_ON)  # ID: OK
VALVE_OFF          = (3, ACTION_OFF) # ID: OK
