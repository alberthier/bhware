...
ELEVATOR_STORE_LEVEL_4= makeServoMoveCommand (ELEVATOR,  165)
ELEVATOR_STORE_LEVEL_3= makeServoMoveCommand (ELEVATOR,  117)
ELEVATOR_STORE_LEVEL_2= makeServoMoveCommand (ELEVATOR,   87)
ELEVATOR_STORE_LEVEL_1= makeServoMoveCommand (ELEVATOR,   62)
...
TORCH_GUIDE_HIDE         = makeServoMoveCommand(TORCH_GUIDE,      155)
