...
ROBOT_CENTER_TO_LATERAL_SENSOR_DISTANCE = 0.0935
ROBOT_EMPTY_GYRATION_RADIUS = 0.288
ROBOT_WITH_PIECE_GYRATION_RADIUS = 0.325
RED_START_X = ROBOT_CENTER_X + 0.050
RED_START_Y = ROBOT_CENTER_Y
RED_START_ANGLE = math.pi / 2.0
BLUE_START_X = ROBOT_CENTER_X + 0.050
BLUE_START_Y = FIELD_WIDTH - ROBOT_CENTER_Y
