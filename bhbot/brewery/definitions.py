...
RED_START_POSE = trajectory.Pose(ROBOT_CENTER_X + 0.050, ROBOT_CENTER_Y, 0.0)
BLUE_START_POSE = trajectory.Pose(ROBOT_CENTER_X + 0.050, FIELD_WIDTH - ROBOT_CENTER_Y, math.pi)
