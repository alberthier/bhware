...
# RX Servos
ELEVATOR_UP   = (SERVO_TYPE_RX, 0, 123)
ELEVATOR_DOWN = (SERVO_TYPE_RX, 0, 64)
ARM_1_OPEN    = (SERVO_TYPE_RX, 1, 123)
ARM_1_CLOSE   = (SERVO_TYPE_RX, 1, 64)
ARM_2_OPEN    = (SERVO_TYPE_RX, 2, 123)
ARM_2_CLOSE   = (SERVO_TYPE_RX, 2, 64)

# AX Servos
MAIN_FIRE_FLIPPER_OPEN       = (SERVO_TYPE_AX, 0, 123)
MAIN_FIRE_FLIPPER_CLOSE      = (SERVO_TYPE_AX, 0, 64)
SECONDARY_FIRE_FLIPPER_OPEN  = (SERVO_TYPE_AX, 0, 123)
SECONDARY_FIRE_FLIPPER_CLOSE = (SERVO_TYPE_AX, 0, 64)
TORCH_GUIDE_OPEN             = (SERVO_TYPE_AX, 1, 123)
TORCH_GUIDE_CLOSE            = (SERVO_TYPE_AX, 1, 64)
FRUITMOTH_HATCH_OPEN         = (SERVO_TYPE_AX, 2, 123)
FRUITMOTH_HATCH_CLOSE        = (SERVO_TYPE_AX, 2, 64)
FRUITMOTH_TUB_OPEN           = (SERVO_TYPE_AX, 3, 123)
FRUITMOTH_TUB_CLOSE          = (SERVO_TYPE_AX, 3, 64)
FRUITMOTH_HATCH_OPEN         = (SERVO_TYPE_AX, 4, 123)
FRUITMOTH_HATCH_CLOSE        = (SERVO_TYPE_AX, 4, 64)
FRUITMOTH_ARM_OPEN           = (SERVO_TYPE_AX, 5, 123)
FRUITMOTH_ARM_CLOSE          = (SERVO_TYPE_AX, 5, 64)
FRUITMOTH_FINGER_OPEN        = (SERVO_TYPE_AX, 6, 123)
FRUITMOTH_FINGER_CLOSE       = (SERVO_TYPE_AX, 6, 64)

# Electromagnets
MAIN_GUN_1_FIRE        = (0, ACTION_ON)
MAIN_GUN_1_LOAD        = (0, ACTION_OFF)
SECONDARY_GUN_1_FIRE   = (0, ACTION_ON)
SECONDARY_GUN_1_LOAD   = (0, ACTION_OFF)
...
PAINT_RELEASE          = (1, ACTION_ON)
PAINT_HOLD             = (1, ACTION_OFF)
