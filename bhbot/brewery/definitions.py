...
SECONDARY_FIRE_FLIPPER_OPEN  = (SERVO_TYPE_AX, 0, 123, DEFAULT_AX_SERVOS_TIMEOUT_MS)
SECONDARY_FIRE_FLIPPER_CLOSE = (SERVO_TYPE_AX, 0, 64,  DEFAULT_AX_SERVOS_TIMEOUT_MS)
